  ...
  describe('Compte Management Update Component', () => {
    ...
    describe('ngOnInit', () => {
      it('Should call Cooperative query and add missing value', () => {
        ...
        const membrede: ICooperative = { id: 38429 };
        compte.membrede = membrede;

        const cooperativeCollection: ICooperative[] = [{ id: 37554 }];
        spyOn(cooperativeService, 'query').and.returnValue(of(new HttpResponse({ body: cooperativeCollection })));
        const additionalCooperatives = [membrede];
      ...
      it('Should update editForm', () => {
        const compte: ICompte = { id: 456 };
        const membrede: ICooperative = { id: 40296 };
        compte.membrede = membrede;
        ...
        expect(comp.cooperativesSharedCollection).toContain(membrede);
      });
    });
