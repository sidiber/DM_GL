  ...
  describe('Course Management Update Component', () => {
    ...
    describe('ngOnInit', () => {
      ...
      it('Should call Plat query and add missing value', () => {
        const course: ICourse = { id: 456 };
        const plats: IPlat[] = [{ id: 27319 }];
        course.plats = plats;

        const platCollection: IPlat[] = [{ id: 33408 }];
      ...
      it('Should update editForm', () => {
        ...
        course.montant = montant;
        const plats: IPlat = { id: 40822 };
        course.plats = [plats];
        const livre: ICompte = { id: 13630 };
        course.livre = livre;
        ...
        expect(comp.comptesSharedCollection).toContain(livre);
      });
    });
