...
export class CourseUpdateComponent implements OnInit {
  ...
  protected updateForm(course: ICourse): void {
    ...
    this.comptesSharedCollection = this.compteService.addCompteToCollectionIfMissing(this.comptesSharedCollection, course.livre);
  }
  ...
  protected loadRelationshipsOptions(): void {
    ...
    this.compteService
      ...
      .pipe(map((comptes: ICompte[]) => this.compteService.addCompteToCollectionIfMissing(comptes, this.editForm.get('livre')!.value)))
