...
public class Course implements Serializable {
    ...
    public Compte getEstlivre() {
        return this.estlivre;
    }

    public Course estlivre(Compte compte) {
        this.setEstlivre(compte);
        return this;
    }

    public void setEstlivre(Compte compte) {
        this.estlivre = compte;
    }
