...
public class RestaurantResource {
    ...
    public ResponseEntity<List<RestaurantDTO>> getAllRestaurants(RestaurantCriteria criteria) {
        log.debug("REST request to get Restaurants by criteria: {}", criteria);
        List<RestaurantDTO> entityList = restaurantQueryService.findByCriteria(criteria);
