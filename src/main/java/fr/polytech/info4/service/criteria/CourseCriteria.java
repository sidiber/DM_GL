...
public class CourseCriteria implements Serializable, Criteria {
    ...
    public CourseCriteria(CourseCriteria other) {
        ...
        this.livreId = other.livreId == null ? null : other.livreId.copy();
    }
    ...
    public LongFilter livreId() {
        if (livreId == null) {
            livreId = new LongFilter();
        }
        return livreId;
    }
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, createdAt, etat, startTime, endTime, montantId, platId, livreId);
    }
