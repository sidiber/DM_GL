...
class PlatResourceIT {
    ...
    private static final String DEFAULT_NOM_PLAT = "q";
    private static final String UPDATED_NOM_PLAT = "v";
    ...
    @Test
    @Transactional
    void checkNomPlatIsRequired() throws Exception {
        int databaseSizeBeforeTest = platRepository.findAll().size();
        // set the field null
        plat.setNomPlat(null);
