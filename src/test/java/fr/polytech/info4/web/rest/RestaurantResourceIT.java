...
class RestaurantResourceIT {
    ...
    private static final String DEFAULT_CODE_P_RESTO = "1";
    private static final String UPDATED_CODE_P_RESTO = "3";
    ...
    void partialUpdateRestaurantWithPatch() throws Exception {
        ...
        partialUpdatedRestaurant.adresseResto(UPDATED_ADRESSE_RESTO).codePResto(UPDATED_CODE_P_RESTO);
