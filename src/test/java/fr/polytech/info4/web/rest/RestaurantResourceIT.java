...
class RestaurantResourceIT {
    ...
    private static final String DEFAULT_NOM_RESTO = "k";
    private static final String UPDATED_NOM_RESTO = "q";
    ...
    private static final String DEFAULT_ADRESSE_RESTO = "F";
    private static final String UPDATED_ADRESSE_RESTO = "d";

    private static final String DEFAULT_CODE_P_RESTO = "8";
    private static final String UPDATED_CODE_P_RESTO = "6";

    private static final String DEFAULT_VILLE_RESTO = "w";
    private static final String UPDATED_VILLE_RESTO = "g";
    ...
    void partialUpdateRestaurantWithPatch() throws Exception {
        ...
        partialUpdatedRestaurant.fraisLivraison(UPDATED_FRAIS_LIVRAISON).villeResto(UPDATED_VILLE_RESTO);
