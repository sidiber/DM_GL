...
class RestaurantResourceIT {
    ...
    private static final String DEFAULT_CODE_P_RESTO = "34";
    private static final String UPDATED_CODE_P_RESTO = "8";
    ...
    void partialUpdateRestaurantWithPatch() throws Exception {
        ...
        partialUpdatedRestaurant.nomResto(UPDATED_NOM_RESTO).villeResto(UPDATED_VILLE_RESTO);
