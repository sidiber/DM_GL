...
class CompteResourceIT {
    ...
    private static final String DEFAULT_EMAIL = "43L@etuSuniv-grenoble-alpes.fr";
    private static final String UPDATED_EMAIL = "VeKn7@.fr";

    private static final String DEFAULT_PHONE_NUMBER = "8";
    private static final String UPDATED_PHONE_NUMBER = "3";
    ...
    private static final String DEFAULT_CODE_P_COMPTE = "4";
    private static final String UPDATED_CODE_P_COMPTE = "6";
    ...
    @Test
    @Transactional
    void getAllComptesByMembredeIsEqualToSomething() throws Exception {
        // Initialize the database
        compteRepository.saveAndFlush(compte);
