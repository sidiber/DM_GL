...
class CompteResourceIT {
    ...
    private static final String DEFAULT_PHONE_NUMBER = "346607";
    private static final String UPDATED_PHONE_NUMBER = "99";
    ...
    private static final String DEFAULT_CODE_P_COMPTE = "1521";
    private static final String UPDATED_CODE_P_COMPTE = "04479";
