...
class SystemePaiementResourceIT {
    ...
    private static final String DEFAULT_NUM_CARTE = "6";
    private static final String UPDATED_NUM_CARTE = "9";
    ...
    void partialUpdateSystemePaiementWithPatch() throws Exception {
        ...
        partialUpdatedSystemePaiement.numCarte(UPDATED_NUM_CARTE).dateExpiration(UPDATED_DATE_EXPIRATION).typeCarte(UPDATED_TYPE_CARTE);
