...
class SystemePaiementResourceIT {
    ...
    private static final String DEFAULT_NUM_CARTE = "7";
    private static final String UPDATED_NUM_CARTE = " ";
    ...
    private static final String DEFAULT_TYPE_CARTE = "M";
    private static final String UPDATED_TYPE_CARTE = "V";
    ...
    void partialUpdateSystemePaiementWithPatch() throws Exception {
        ...
        partialUpdatedSystemePaiement.numCarte(UPDATED_NUM_CARTE).montant(UPDATED_MONTANT).dateFacture(UPDATED_DATE_FACTURE);
